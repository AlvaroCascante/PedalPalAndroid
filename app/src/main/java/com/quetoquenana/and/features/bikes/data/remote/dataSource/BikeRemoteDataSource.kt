...
interface BikeRemoteDataSource {
    ...
    suspend fun getBike(id: UUID): BikeDto
    suspend fun getBikeHistory(id: UUID): List<BikeHistoryDto>
    suspend fun createBike(request: CreateBikeRequest): BikeDto
    suspend fun addBikeComponent(bikeId: UUID, request: AddComponentRequest): BikeComponentDto
