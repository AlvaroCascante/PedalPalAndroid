...
import com.quetoquenana.and.pedalpal.features.login.data.remote.dataSource.AuthRemoteDataSourceImpl
import com.quetoquenana.and.pedalpal.features.login.domain.repository.AuthRepository
import com.quetoquenana.and.pedalpal.features.login.data.repository.AuthRepositoryImpl
import com.quetoquenana.and.pedalpal.features.login.data.remote.dataSource.FirebaseAuthDataSource
import com.quetoquenana.and.pedalpal.features.login.data.remote.dataSource.FirebaseAuthDataSourceImpl
import com.quetoquenana.and.pedalpal.features.appointments.data.remote.dataSource.AppointmentsRemoteDataSource
import com.quetoquenana.and.pedalpal.features.appointments.data.remote.dataSource.AppointmentsRemoteDataSourceImpl
import com.quetoquenana.and.pedalpal.features.appointments.domain.repository.AppointmentsRepository
import com.quetoquenana.and.pedalpal.features.appointments.data.repository.AppointmentsRepositoryImpl
import com.quetoquenana.and.pedalpal.features.suggestions.data.remote.dataSource.SuggestionsRemoteDataSource
import com.quetoquenana.and.pedalpal.features.suggestions.data.remote.dataSource.SuggestionsRemoteDataSourceImpl
import com.quetoquenana.and.pedalpal.features.suggestions.domain.repository.SuggestionsRepository
import com.quetoquenana.and.pedalpal.features.suggestions.data.repository.SuggestionsRepositoryImpl
import com.quetoquenana.and.pedalpal.features.landing.data.remote.dataSource.LandingRemoteDataSource
import com.quetoquenana.and.pedalpal.features.landing.data.remote.dataSource.LandingRemoteDataSourceImpl
import com.quetoquenana.and.pedalpal.features.landing.domain.repository.LandingRepository
import com.quetoquenana.and.pedalpal.features.landing.data.repository.LandingRepositoryImpl
import dagger.Binds
